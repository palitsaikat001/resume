...
const Features = () => {
  ...
  return (
    ...
    <div id='features' className='flex flex-col items-center my-0 scroll-mr-12'>
        ...
        <Title title='Build your Resume' description='Our streamlined process helps you create a professional resume in minutes with Intelligent AI-powered tools and festures.'/>
