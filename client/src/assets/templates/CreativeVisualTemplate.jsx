...
const CreativeVisualTemplate = ({ data, accentColor }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white text-gray-800 leading-relaxed">
      ...
      <div className="flex flex-wrap justify-center gap-2 mt-1 mb-2 text-sm text-gray-600">
      ...
      <section className="mb-3">
        {data.professional_summary && (
          <div>
            ...
            <p className="text-gray-700 text-sm mt-1">{data.professional_summary}</p>
          </div>
        )}
      </section>
        ...
        <section className="mb-3">
          ...
          <div>
            {data.project.map((p, i) => (
              <div
                key={i}
                className="p-2 pt-1 mb-2 rounded-md border-l-4"
